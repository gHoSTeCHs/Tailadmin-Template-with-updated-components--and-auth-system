			...
			<div className="space-y-6">
				...
				<div>
					...
					<p className="text-sm text-gray-600 dark:text-gray-400">
						A comprehensive toast notification system with full dark mode
						support, multiple variants, and flexible positioning.
					</p>
				</div>
					...
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
						...
						<div>
							...
							<Select
								...
								onChange={(value) => setCustomPosition(value as ToastPosition)}
							/>
						</div>
					</div>
